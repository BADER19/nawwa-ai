...
class Prompt{
    ...
    answer(){
        ...
        let msg = {
            "plotly": "Renderer: Plotly. Ready to chart your data.",
            "mermaid": "Renderer: Mermaid. Describe your flowchart or sequence.",
            "svg": "Renderer: SVG. Building conceptual shapes and connectors.",
            "d3": "Renderer: D3. Graphs, nodes, and links.",
            "math": "Renderer: Math (image). Server-rendered PNG for functions.",
            "math interactive": "Renderer: Math Interactive. Explore functions with Plotly.",
        }[this.chatModel]
