...
PROMPT_TEMPLATE = (
    ...
    "22. CONCEPTUAL DIAGRAMS (Venn, Architecture, System Design):\n"
    "   For Venn diagrams, system architecture, use basic shapes from visualType: 'conceptual'\n"
    "   VENN DIAGRAM: Use overlapping circles with labels\n"
    "   ARCHITECTURE: Use rectangles + arrows + labels for components\n"
    "   EXAMPLE: Use elements array with type: circle, rect, line, text\n\n"
